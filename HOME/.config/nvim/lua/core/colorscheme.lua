...
M.setup = function()
  ...
  local groups = {
    ...
    DiffAdd = { fg = c.none, bg = c.dark_green, bold = false, italic = false },
    DiffAdded = { fg = c.none, bg = c.dark_green, bold = false, italic = false },
    DiffChange = { fg = c.none, bg = c.dark_magenta, bold = false, italic = false },
    DiffChanged = { fg = c.none, bg = c.dark_magenta, bold = false, italic = false },
