...
M.setup = function()
  ...
  local groups = {
    ...
    DiffAdd = { fg = c.gray07, bg = c.dark_green },
    DiffAdded = { fg = c.gray07, bg = c.dark_green },
    DiffChange = { fg = c.gray07, bg = c.dark_blue },
    DiffChanged = { fg = c.gray07, bg = c.dark_blue },
    DiffChangeDelete = { fg = c.gray07, bg = c.dark_magenta },
    DiffDelete = { fg = c.gray07, bg = c.dark_red },
    DiffRemoved = { fg = c.gray07, bg = c.dark_red },
    DiffText = { fg = c.gray07, bg = c.dark_blue },
    DiffModified = { fg = c.gray07, bg = c.dark_cyan },
    DiffNewFile = { fg = c.gray07, bg = c.dark_cyan },
