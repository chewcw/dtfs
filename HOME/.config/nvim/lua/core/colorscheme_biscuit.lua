...
M.setup = function()
    ...
    HI(0, "DiffChanged", { ctermbg = 0, fg = "#c5c5c6", bg = "#05294a" })
    ...
    HI(0, "Structure", { fg = "#7E9A6B" })
    HI(0, "Tag", { fg = "#959A6B" })
    HI(0, "Todo", { bg = "#2D2424", fg = "#959A6B" })
    HI(0, "Typedef", { fg = "#959A6B" })
    HI(0, "DiffText", { link = "DiffChange" })
    HI(0, "DiffAdded", { ctermbg = 0, bg = "#132f33" })
    HI(0, "DiffFile", { bg = "#1A1515", fg = "#F07342" })
    HI(0, "DiffNewFile", { ctermbg = 0, bg = "#3c4e77" })
    HI(0, "DiffLine", { bg = "#1A1515", fg = "#E39C45" })
    HI(0, "DiffRemoved", { ctermbg = 0, bg = "#4c0f0f" })
    HI(0, "DiffModified", { ctermbg = 0, bg = "#3c4e77" })
    ...
    HI(0, "DiagnosticError", { fg = "#CF223E" })
    HI(0, "DiagnosticWarn", { fg = "#F0CA42" })
    HI(0, "DiagnosticInfo", { fg = "#DCC9BC" })
    HI(0, "DiagnosticHint", { fg = "#756D94" })
    HI(0, "DiagnosticUnderlineWarning", { sp = "#F0CA42", undercurl = true })
    ...
    HI(0, "LspDiagnosticsSignError", { link = "DiagnosticError" })
    HI(0, "LspDiagnosticsSignWarning", { link = "DiagnosticWarn" })
    HI(0, "LspDiagnosticsSignInformation", { link = "DiagnosticInfo" })
    HI(0, "LspDiagnosticsSignHint", { link = "DiagnosticHint" })
    ...
    HI(0, "Normal", { fg = "#bcbcbc", bg = "#050b0c" })
    HI(0, "TSInclude", { fg = "#E39C45" })
    HI(0, "Special", { fg = vim.api.nvim_get_hl_by_name("Normal", {}).foreground })
    HI(0, "TSKeywordFunction", { link = "Function" })
    HI(0, "TSKeywordOperator", { link = "Operator" })
    HI(0, "TSLabel", { link = "Label" })
    HI(0, "TSMethod", { fg = "#E39C45" })
    HI(0, "TSNamespace", { fg = "#F07342" })
    HI(0, "TSNone", { link = "NoneText" })
    ...
    HI(0, "TSPunctBracket", { link = "Delimiter" })
    HI(0, "TSPunctSpecial", { link = "Special" })
    HI(0, "TSRepeat", { link = "Keyword" })
    ...
    HI(0, "LineNr", { link = "Whitespace" })
    HI(0, "TSStrong", { bold = true })
    HI(0, "TSEmphasis", { fg = "#E39C45" })
    ...
    HI(0, "DiffChange", { ctermbg = 0, fg = "#c5c5c6", bg = "#05294a" })
    HI(0, "DiffChangeDelete", { ctermbg = 0, bg = "#674ea7" })
    HI(0, "TSType", { fg = "#959A6B" })
    HI(0, "DiffAdd", { ctermbg = 0, bg = "#132f33" })
    HI(0, "TSVariable", { fg = "#F07342" })
    HI(0, "DiffDelete", { ctermbg = 0, bg = "#4c0f0f" })
    HI(0, "TSDefinition", { sp = "#9C8181", underline = true })
    HI(0, "TSDefinitionUsage", { sp = "#9C8181", underline = true })
    HI(0, "TSCurrentScope", { bold = true })
    HI(0, "LspInlayHint", { fg = "#725A5A" })
    ...
    HI(0, "@text.strike",
        { cterm = { strikethrough = true }, fg = "#EE5396", link = "TSStrike", strikethrough = true })
    ...
    HI(0, "NormalNC", { fg = "#bcbcbc", bg = "#141819" })
    ...
    HI(0, "TreesitterContext", { link = "Normal" })
    HI(0, "TreesitterContextSeparator", { link = "NonText" })
    HI(0, "TreesitterContextLineNumber", {
    ...
    HI(0, "IndentBlanklineChar", { fg = "#1d2324" })
    HI(0, "IndentBlanklineSpaceChar", { link = "IndentBlanklineChar" })
    HI(0, "IndentBlanklineSpaceCharBlankline", { link = "IndentBlanklineChar" })
    HI(0, "IndentBlanklineContextChar", {
      default,
      bg = vim.api.nvim_get_hl_by_name("Whitespace", {}).foreground
    })
    HI(0, "CmpDocumentationBorder", { link = "FloatBorder" })
    HI(0, "CmpDocumentation", { default })
    HI(0, "CmpItemKindKeyword", { default })
    HI(0, "CmpItemKindVariable", { default })
    HI(0, "Comment", { fg = "#725A5A" })
    ...
    HI(0, "NvimTreeEmptyFolderName", { default })
    HI(0, "NvimTreeFolderIcon", { default })
    HI(0, "NvimTreeFolderName", { default })
    HI(0, "NvimTreeImageFile", { default })
    HI(0, "NvimTreeIndentMarker", { fg = "#393939" })
    HI(0, "Keyword", { fg = "#42bff0" })
    HI(0, "NvimTreeOpenedFolderName", { default })
    HI(0, "NvimTreeWinSeparator", { default })
    ...
    HI(0, "StatusLineDiagnosticError", { fg = "#EE5396" })
    HI(0, "StatusLineDiagnosticWarn", { fg = "#F0CA42" })
    ...
    HI(0, "TelescopeResultsTitle", { default })
    ...
    HI(0, "TelescopePreviewTitle", { default = true })
    ...
    HI(0, "TelescopeMatching", { fg = "#3DDBD9" })
    ...
    HI(0, "DiagnosticUnderlineError",
        { cterm = { undercurl = true }, fg = "#CF223E", sp = "#CF223E", undercurl = true })
    HI(0, "DiagnosticUnderlineWarn",
        { cterm = { undercurl = true }, fg = "#F0CA42", sp = "#F0CA42", undercurl = true })
    ...
    HI(0, "StatusLineNC", { link = "NormalNC" })
    ...
    HI(0, "TSVariableBuiltin", { fg = "#F07342" })
    HI(0, "TSURI", { fg = "#E39C45", underline = true })
    HI(0, "TSTypeBuiltin", { fg = "#959A6B" })
    ...
    HI(0, "TSFuncBuiltin", { fg = "#E39C45" })
    HI(0, "TSException", { link = "Exception" })
    HI(0, "TSConditional", { link = "Keyword" })
    ...
    HI(0, "CmpItemKindSnippet", { default })
    HI(0, "CmpItemKindOperator", { default })
    HI(0, "CmpItemKindEnumMember", { default })
    HI(0, "CmpItemKindTypeParameter", { default })
    HI(0, "Float", { fg = "#E39C45" })
    HI(0, "Delimiter", { link = "Operator" })
    HI(0, "Define", { fg = "#CF223E" })
    HI(0, "CmpItemKindUnit", { default })
    HI(0, "CmpItemKindEvent", { default })
    HI(0, "CmpItemKindStruct", { default })
    HI(0, "CmpItemKindInterface", { default })
    HI(0, "CmpItemKindClass", { default })
    HI(0, "CmpItemKindConstructor", { default })
    HI(0, "CmpItemKindMethod", { default })
    HI(0, "CursorLineNr", { default })
    HI(0, "CursorLine", { default })
    HI(0, "CursorColumn", { bg = "#2D2424" })
    HI(0, "ColorColumn", { bg = "#141819" })
    HI(0, "Identifier", { fg = "#F07342" })
    HI(0, "DiagnosticFloatingInfo", { link = "DiagnosticInfo" })
    HI(0, "@event", { link = "Identifier" })
    HI(0, "CmpItemAbbrDeprecated", { default })
    HI(0, "CmpItemAbbr", { default })
    HI(0, "Conditional", { fg = "#CF223E" })
    HI(0, "CmpItemKind", { default })
    HI(0, "@typeParameter", { link = "Type" })
    HI(0, "CmpItemMenu", { default })
    HI(0, "DiagnosticSignInfo", { link = "DiagnosticInfo" })
    HI(0, "CmpItemKindValue", { default })
    HI(0, "CmpItemKindReference", { default })
    HI(0, "CmpItemKindProperty", { default })
    HI(0, "CmpItemAbbrMatch", { default })
    HI(0, "CmpItemKindModule", { default })
    ...
    HI(0, "DiagnosticUnderlineHint",
        { cterm = { undercurl = true }, fg = "#D0D0D0", sp = "#756D94", undercurl = true })
    ...
    HI(0, "WhichKeyFloat", { link = "FloatBorder" })
end
